...
our $SCHEMA = [
    ...
    {sep => undef},
    {sep => 'Break'},
    {beg => ['More Options', 'applications-system']},
        {item => ['openbox --exit', 'Log Out',   'applications-system']},
        {item => ['systemctl poweroff',    'Shutdown',          'applications-system']},
        {item => ['systemctl reboot',  'Reboot',        'applications-system']},
        {item => ['systemctl suspend',               'Suspend', 'applications-system']},
        {item => ['systemctl hibernate', 'Hibernate',   'applications-system']},
    {end => undef},
